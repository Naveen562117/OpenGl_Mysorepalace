...
{//base
    ...
    glPushMatrix();
    glColor3f(1.0,1.0,1.0);//pillars'background
    ...
    glPushMatrix();
    glColor3f(1.0,1.0,1.0);//line strip behind the pillar
    ...
    glPushMatrix();
    glColor3f(1.0,1.0,1.0);//top of the pillars
...
glPushMatrix();
    ...
    glColor3f(1.0,0.86,0.57);//blue tower
    glScaled(1,3,1);
    glutSolidCube(1.0);
    ...
    glColor3f(1.0,0.86,0.57);//block btw red n green
    glScaled(1,2,1);
    glutSolidCube(1.0);
    glPopMatrix();
    ...
    glColor3f(1.0,0.86,0.57);//green tower
    glScaled(1,3,1);
    glutSolidCube(1.0);
...
glColor3f(1.0,0.86,0.57);
    ...
    glPopMatrix();
     ...
     glPushMatrix();
    glTranslated(4.0,1.0,5.0);
glColor3f(1.0,0.86,0.57);    glScaled(1,2,1);
    glutSolidCube(1.0);
    glPopMatrix();

    glPushMatrix();
    glTranslated(5.0,1.5,5.2);
glColor3f(1.0,0.86,0.57);    glScaled(1,3,1);
    glutSolidCube(1.0);
...
glColor3f(1.0,0.86,0.57);
    ...
    glPopMatrix();
    glPushMatrix();
glColor3f(1.0,0.86,0.57);    glTranslated(-2,1.5,5);
    glScaled(2,2,1);
    drawarch();
    glPopMatrix();
    ...
    glPushMatrix();
glColor3f(1.0,0.86,0.57);    glTranslated(-3.3,1.5,5);
    glScaled(2.5,2,1);
    drawarch();
    glPopMatrix();
...
glColor3f(1.0,1.0,1.0);
    ...
    glPushMatrix();
    glColor3f(1.0,1.0,1.0);glTranslated(3.3,1.5,5);
    glScaled(2.5,2,1);
    drawarch();
    glPopMatrix();
...
glColor3f(0.8,0.498039,0.16078);
octagon();
glColor3f(0.8,0.498039,0.16078);
baseoctagon();
glPopMatrix();
